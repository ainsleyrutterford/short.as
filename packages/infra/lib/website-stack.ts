...
export class WebsiteStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: WebsiteStackProps) {
    ...
    // TODO: Could add some code here to replace API URLs with the httpApi URL generated by CDK,
    // TODO: for now the dev and prod URLs are just manually pasted in the .env files in the site package
