...
const ToShortenCard = ({ longUrl, setLongUrl, setShortUrlId, setIsOnShortenCard }: CardProps) => (
...
const HasShortenedCard = ({ longUrl, setLongUrl, shortUrlId, setShortUrlId, setIsOnShortenCard }: CardProps) => {
  const shortUrl =
    process.env.NEXT_PUBLIC_STAGE === "prod" ? `https://short.as/${shortUrlId}` : `https://dev.short.as/${shortUrlId}`;
  return (
    <Card className="mt-10 sm:mt-16">
      <CardHeader>
      ...
      <div className="max-w-screen-md mx-auto px-4">
        {isOnShortenCard ? (
          <ToShortenCard
            ...
            setIsOnShortenCard={setIsOnShortenCard}
          />
        ) : (
          <HasShortenedCard
            longUrl={longUrl}
