...
function ChartTooltipContent({
  ...
  active?: boolean
  payload?: Array<{ dataKey?: string; name?: string; value?: number | string; payload?: { fill?: string }; color?: string; type?: string }>
  label?: string
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          .map((item: { dataKey?: string; name?: string; value?: number | string; payload?: { fill?: string }; color?: string; type?: string }, index: number) => {
